...
import site.site8.springboot.model.SysRolePermissionExample.Criteria;
import site.site8.springboot.model.SysRolePermissionExample.Criterion;
...
public class SysRolePermissionSqlProvider {
    ...
    public String countByExample(SysRolePermissionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sysrolepermission");
    ...
    public String deleteByExample(SysRolePermissionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sysrolepermission");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(SysRolePermission record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("sysrolepermission");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPermissionid() != null) {
            sql.SET("permissionId = #{record.permissionid,jdbcType=INTEGER}");
        }
