...
import site.site8.springboot.model.StudentExample.Criteria;
import site.site8.springboot.model.StudentExample.Criterion;
...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getsId() != null) {
            sql.VALUES("s_id", "#{sId,jdbcType=INTEGER}");
        }
        
        if (record.getsName() != null) {
            sql.VALUES("s_name", "#{sName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getsId() != null) {
            sql.SET("s_id = #{record.sId,jdbcType=INTEGER}");
        }
        
        if (record.getsName() != null) {
            sql.SET("s_name = #{record.sName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getsName() != null) {
            sql.SET("s_name = #{sName,jdbcType=VARCHAR}");
        }
        ...
        sql.WHERE("s_id = #{sId,jdbcType=INTEGER}");
