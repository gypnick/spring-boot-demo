...
import site.site8.springboot.model.SysPermissionExample.Criteria;
import site.site8.springboot.model.SysPermissionExample.Criterion;
...
public class SysPermissionSqlProvider {
    ...
    public String countByExample(SysPermissionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("syspermission");
    ...
    public String insertSelective(SysPermission record) {
        ...
        if (record.getResourcetype() != null) {
            sql.VALUES("resourceType", "#{resourcetype,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(SysPermissionExample example) {
        ...
        sql.SELECT("name");
        sql.SELECT("resourceType");
        sql.SELECT("url");
        sql.SELECT("permission");
        sql.SELECT("parentId");
        sql.SELECT("parentIds");
        sql.SELECT("available");
        sql.FROM("syspermission");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getResourcetype() != null) {
            sql.SET("resourceType = #{record.resourcetype,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(SysPermission record) {
        ...
        if (record.getResourcetype() != null) {
            sql.SET("resourceType = #{resourcetype,jdbcType=VARCHAR}");
        }
